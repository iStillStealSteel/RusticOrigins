package dev.istillstealsteel.originsrustic.common.registry;
...
import dev.istillstealsteel.originsrustic.common.apoli.condition.item.HasPowerContition;
import dev.istillstealsteel.originsrustic.common.apoli.condition.item.ToolActionCondition;
import dev.istillstealsteel.originsrustic.common.tag.OriginsRusticItemTags;
...
public class OriginsRusticConditions {

    public static final DeferredRegister<BiEntityCondition<?>> BIENTITY_CONDITIONS = DeferredRegister.create(ApoliRegistries.BIENTITY_CONDITION_KEY, OriginsRustic.MODID);
    ...
    public static final DeferredRegister<EntityCondition<?>> ENTITY_CONDITIONS = DeferredRegister.create(ApoliRegistries.ENTITY_CONDITION_KEY, OriginsRustic.MODID);
    ...
    public static final DeferredRegister<ItemCondition<?>> ITEM_CONDITIONS = DeferredRegister.create(ApoliRegistries.ITEM_CONDITION_KEY, OriginsRustic.MODID);
    public static final RegistryObject<SimpleItemCondition> DIGGERS = ITEM_CONDITIONS.register("diggers", () ->
        new SimpleItemCondition( stack ->
            ...
            stack.is(OriginsRusticItemTags.DIGGERS) ||
    ...
    public static final RegistryObject<SimpleItemCondition> AXE = ITEM_CONDITIONS.register("axe", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.AXES)
        ));
    public static final RegistryObject<SimpleItemCondition> SHOVEL = ITEM_CONDITIONS.register("shovel", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.SHOVELS)
        ));
    public static final RegistryObject<SimpleItemCondition> SHEARS = ITEM_CONDITIONS.register("shears", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.SHEARS)
        ));
    ...
    public static final RegistryObject<SimpleItemCondition> SHIELD = ITEM_CONDITIONS.register("shield", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.SHIELDS)
        ));
    public static final RegistryObject<SimpleItemCondition> HELMET = ITEM_CONDITIONS.register("helmet", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.HELMETS)
        ));
    public static final RegistryObject<SimpleItemCondition> CHESTPLATE = ITEM_CONDITIONS.register("chestplate", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.CHESTPLATES)
        ));
    public static final RegistryObject<SimpleItemCondition> LEGGINGS = ITEM_CONDITIONS.register("leggings", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.LEGGINGS)
        ));
    public static final RegistryObject<SimpleItemCondition> SHOES = ITEM_CONDITIONS.register("shoes", () ->
        new SimpleItemCondition(stack ->
            ...
            stack.is(OriginsRusticItemTags.SHOES)
        ));
    ...
    public static final DeferredRegister<BlockCondition<?>> BLOCK_CONDITIONS = DeferredRegister.create(ApoliRegistries.BLOCK_CONDITION_KEY, OriginsRustic.MODID);

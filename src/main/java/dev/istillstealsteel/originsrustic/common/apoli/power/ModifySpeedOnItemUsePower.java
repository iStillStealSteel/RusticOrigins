...
import dev.istillstealsteel.originsrustic.common.apoli.configuration.ModifySpeedOnItemUseConfiguration;
...
public class ModifySpeedOnItemUsePower extends ValueModifyingPowerFactory<ModifySpeedOnItemUseConfiguration> {
    ...
    public static float modifySlowDown(Player player, float slowdownMultiplier) {
        ...
        return Mth.clamp(IPowerContainer.modify(player, OriginsRusticPowers.MODIFY_SPEED_ON_ITEM_USE.get(), slowdownMultiplier,

...
public class CommonUtils {
    public static final String origins_rustic = "OriginsRustic";
    ...
    public static CompoundTag getOriginsRusticTag(CompoundTag nbt) {
        if(nbt.contains(origins_rustic, Tag.TAG_COMPOUND)) {
            return nbt.getCompound(origins_rustic);
        }
        return new CompoundTag();
    }
    
    public static CompoundTag getOrCreateOriginsRusticTag(CompoundTag nbt) {
        if(nbt.contains(origins_rustic, Tag.TAG_COMPOUND)) {
            return nbt.getCompound(origins_rustic);
        }
        CompoundTag entry = new CompoundTag();
        nbt.put(origins_rustic, entry);
        return entry;
    }

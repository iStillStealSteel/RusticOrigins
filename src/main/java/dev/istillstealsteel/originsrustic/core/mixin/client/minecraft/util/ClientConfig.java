...
public class ClientConfig {
    ...
    public ClientConfig(ForgeConfigSpec.Builder builder) {
        showModifyFoodTooltip = builder.translation("config.origins_rustic.show_modify_food_tooltip")
            .define("modify_food_tooltip", true);
        showPotionBonusTooltip = builder.translation("config.origins_rustic.show_potion_bonus_tooltip")

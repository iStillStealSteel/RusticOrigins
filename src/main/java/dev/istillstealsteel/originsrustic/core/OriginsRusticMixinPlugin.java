package dev.istillstealsteel.originsrustic.core;
...
public class OriginsRusticMixinPlugin implements IMixinConfigPlugin {
    ...
    private boolean checkForClass(String cls) {
        try {
            Class.forName(cls, false, OriginsRusticMixinPlugin.class.getClassLoader());
            return true;
